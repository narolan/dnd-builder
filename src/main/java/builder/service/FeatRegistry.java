...
import com.dnd.builder.model.FeatDefinition;
...
public class FeatRegistry {
    ...
    public List<FeatDefinition> getAllFeats() { return Collections.unmodifiableList(feats); }
    public FeatDefinition getById(String id)  { return byId.get(id); }

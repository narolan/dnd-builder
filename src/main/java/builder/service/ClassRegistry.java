...
import com.dnd.builder.model.ClassDefinition.SpellcastingInfo;
import com.dnd.builder.model.SubclassDefinition;
...
public class ClassRegistry {
    ...
    public List<ClassDefinition> getAllClasses() { return Collections.unmodifiableList(classes); }
    public ClassDefinition getById(String id)    { return byId.get(id); }

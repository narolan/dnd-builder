...
public class SpellRegistry {
    ...
    public SpellDefinition getById(String id)  { return byId.get(id); }

    /** Spells available for a given class, optionally filtered by level */
    public List<SpellDefinition> forClass(String classId, Integer level) {
    ...
    public List<SpellDefinition> cantripsFor(String classId) { return forClass(classId, 0); }

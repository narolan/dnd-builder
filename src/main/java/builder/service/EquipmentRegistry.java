...
import com.dnd.builder.model.EquipmentChoice;
import com.dnd.builder.model.EquipmentSlot;
...
public class EquipmentRegistry {
    ...
    public EquipmentRegistry() { byClass = buildAll(); }

    public List<EquipmentSlot> forClass(String classId) {

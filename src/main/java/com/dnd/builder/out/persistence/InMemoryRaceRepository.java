...
import com.dnd.builder.core.model.FlexibleBonus;
import com.dnd.builder.core.model.Race;
import com.dnd.builder.core.port.out.RaceRepository;
...
public class InMemoryRaceRepository implements RaceRepository {
    ...
    @Override
    public List<Race> findAll() { return Collections.unmodifiableList(races); }

    @Override
    public Race findById(String id) { return byId.get(id); }
